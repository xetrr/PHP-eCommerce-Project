...
?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered main-table text-center">
                    ...
                    foreach ($rows as $row) {
                        ...
                        echo " <a href='members.php?do=delete&userid=" . $row['user_id'] . "' class='btn btn-danger confirm'>Delete</a>";
                        if ($row['RegStatus'] == 0) {
                            echo " <a href='members.php?do=Approve&userid=" . $row['user_id'] . "' class='btn btn-info'>Approve</a></td>";
                        };
                        echo "</tr>";
                    }
                    ?>
    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($check == 1) {
                $userMsg = "<div class='alert alert-danger'>" . "sorry this user already exists" . "</div>";
            ...
            <div class="container">
                <form action="?do=update" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-sm-10 col-md-6">
                            <input type="text" name="username" id="" class="form-control" value="<?php echo $row['Username'] ?>" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-sm-10 col-md-6">
                            <input type="hidden" name="oldpassword" id="" value="<?php echo $row['Password'] ?>">
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-sm-10 col-md-6">
                            <input type="email" name="email" id="" value="<?php echo $row['Email'] ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-sm-10 col-md-6">
                            <input type="text" name="fullName" id="" value="<?php echo $row['FullName'] ?>" class="form-control">
                        </div>
                    </div>
...
<?php
        ...
        if ($check > 0) {
            ...
            $stmt->execute();
            $userMsg =  "<div class='alert alert-success'>" . $stmt->rowCount() . 'record deleted </div>';
            redirectHome($userMsg, 'back');
        } else {
            echo "false ID";
        }
        ...
        if ($check > 0) {
            ...
            $stmt->execute(array($userid));
            $userMsg =  "<div class='alert alert-success'>" . $stmt->rowCount() . "User Approved </div>";
            redirectHome($userMsg, 'back');
        } else {
            echo "false ID";
        }
